...
resource "google_container_cluster" "lab" {
  ...
  # TODO: disable the ABAC authorizer
  # TODO: disable basic authentication
  # TODO: enable NetworkPolicy
  # TODO: enable PodSecurityPolicy
  # TODO: disable the Kubernetes dashboard
  ...
  node_config {
    ...
    # TODO: enable the Metadata Concealment workload proxy
